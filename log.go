...
func (l *Tlogger) SetHighlighting(highlighting bool) {
...
func (l *Tlogger) SetLevelByString(level string) {
	l.level = StringToLogLevel(level)
}

func (l *Tlogger) SetRotateByDay() {
	l.dailyRolling = true
	l.logSuffix = genDayTime(time.Now())
}

func (l *Tlogger) SetRotateByHour() {
	l.hourRolling = true
	l.logSuffix = genHourTime(time.Now())
}

func (l *Tlogger) rotate() error {
	l.lock.Lock()
	defer l.lock.Unlock()
...
func (l *Tlogger) doRotate(suffix string) error {
...
func (l *Tlogger) SetOutput(out io.Writer) {
	l._log = log.New(out, l._log.Prefix(), l._log.Flags())
}

func (l *Tlogger) SetOutputByName(path string) error {
...
func (l *Tlogger) log(t LogType, v ...interface{}) {
...
func (l *Tlogger) logf(t LogType, format string, v ...interface{}) {
	if l.level|LogLevel(t) != l.level {
		return
	}
...
func Newlogger(w io.Writer, prefix string) *Tlogger {
	return &Tlogger{_log: log.New(w, prefix, LstdFlags), level: LOG_LEVEL_ALL, highlighting: true}
}
